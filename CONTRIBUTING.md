Contributing to LAVA Core
============================

The LAVA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LAVA Core project, and is not to be
confused with overall LAVA Network Protocol consensus changes.

Whether a pull request is merged into LAVA Core rests with the project merge
...
Patches that change LAVA consensus rules are considerably more involved than
...
Where a patch set proposes to change the LAVA consensus, it must have been
...
The project leader is the release manager for each LAVA Core release.
