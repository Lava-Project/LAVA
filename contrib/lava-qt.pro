...
RESOURCES += src/qt/lava.qrc src/qt/lava_locale.qrc

TRANSLATIONS += src/qt/locale/lava_bg.ts \
                src/qt/locale/lava_de.ts \
                src/qt/locale/lava_en.ts \
                src/qt/locale/lava_es.ts \
                src/qt/locale/lava_fi.ts \
                src/qt/locale/lava_fr.ts \
                src/qt/locale/lava_it.ts \
                src/qt/locale/lava_ja.ts \
                src/qt/locale/lava_pl.ts \
                src/qt/locale/lava_pt.ts \
                src/qt/locale/lava_ru.ts \
                src/qt/locale/lava_sk.ts \
                src/qt/locale/lava_sv.ts \
                src/qt/locale/lava_vi.ts \
                src/qt/locale/lava_zh_CN.ts \
                src/qt/locale/lava_zh_TW.ts
