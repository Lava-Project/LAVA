...
In order to support loading of multiple wallets in lava-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lava.cpp.
...
Changes to lava.cpp
----------------------
lava.cpp is the entry point into lava-qt, and as such, will require some minor modifications to provide hooks for
