...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 LAVA at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zLAVA send
enum ZerocoinSpendStatus {
    ZLAVA_SPEND_OKAY = 0,                            // No error
    ZLAVA_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZLAVA_WALLET_LOCKED = 2,                         // Wallet was locked
    ZLAVA_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZLAVA_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZLAVA_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZLAVA_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZLAVA_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZLAVA_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZLAVA_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZLAVA_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZLAVA_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZLAVA_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZLAVA_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZLAVA_SPENT_USED_ZLAVA = 14                       // Coin has already been spend
};
