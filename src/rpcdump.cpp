...
Value dumpwallet(const Array& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by LAVA %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"lavaaddress\"\n"
            "\nEncrypts a private key corresponding to 'lavaaddress'.\n"
            "\nArguments:\n"
            "1. \"lavaaddress\"   (string, required) The lava address for the private key (you must hold the key already)\n"
