...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LAVA features */
        {"lava", "masternode", &masternode, true, true, false},
        {"lava", "listmasternodes", &listmasternodes, true, true, false},
        {"lava", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lava", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lava", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lava", "masternodedebug", &masternodedebug, true, true, false},
        {"lava", "startmasternode", &startmasternode, true, true, false},
        {"lava", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lava", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lava", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lava", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lava", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lava", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lava", "mnbudget", &mnbudget, true, true, false},
        {"lava", "preparebudget", &preparebudget, true, true, false},
        {"lava", "submitbudget", &submitbudget, true, true, false},
        {"lava", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lava", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lava", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lava", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lava", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lava", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lava", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lava", "checkbudgets", &checkbudgets, true, true, false},
        {"lava", "mnsync", &mnsync, true, true, false},
        {"lava", "spork", &spork, true, true, false},
        {"lava", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"lava", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lavad, or the -server option to lava-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:61476/\n";
}
