...
QString BitcoinUnits::id(int unit)
{
    ...
    case LAVA:
        return QString("lava");
    case mRUP:
        return QString("mlava");
    case uRUP:
        return QString::fromUtf8("ulava");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case LAVA:
            return QString("LAVA");
        case mRUP:
            return QString("Milli-LAVA (1 / 1" THIN_SP_UTF8 "000)");
        case uRUP:
            return QString("Micro-LAVA (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
