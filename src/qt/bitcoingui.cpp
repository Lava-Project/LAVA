                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LAVA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLAVA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LAVA Core"), this);
    aboutAction->setStatusTip(tr("Show information about LAVA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LAVA"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the LAVA Core help message to get a list with possible LAVA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LAVA Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("LAVA Core"); // default title
