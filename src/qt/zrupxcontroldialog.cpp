...
std::list<std::string> ZRupxControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZRupxControlDialog::listMints;
...
void ZRupxControlDialog::updateLabels()
{
    ...
    privacyDialog->setZRupxControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZRupxControlDialog::GetSelectedMints()
{
